...
export const t = {
  ...
  intro: {
    title: "무엇으로 만들었나",
    sub: "여섯 개 도구의 기능 하나하나가 어떤 기술 위에 서 있는지, 그리고 그중 무엇이 네트워크를 타는지",
  },
  ...
  city: {
    ...
    legend:
      "유닛 높이 = 소스 줄 수 · 왼쪽 면 포트 = 기대는 기술(색은 그 성격) · 앞면 계기판 = 줄 수 눈금 · 지붕 안테나 = 바깥과 통함 · 덕트 = wasm",
    pipes: "머리 위 배관 = 흐름이 실제로 거치는 순서. 재생하면 그 관에 궤짝이 흐릅니다",
    walls:
