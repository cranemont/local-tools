...
export const APPS: AppMeta[] = [
  ...
  { id: "lab", label: "실험장", blurb: "한국어 문장으로 임베딩 모델 다섯 개를 같은 조건에서 재봅니다. 모델은 브라우저 안에서", path: "../lab/" },
  {
    id: "stack",
    label: "기술 지도",
    blurb: "도구 열 개가 어떤 기술 위에 서 있는지 3D 도시로. 무엇이 네트워크를 타는지도 표시",
    path: "../stack/",
    meta: true,
  },
...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    app: "pdf",
    label: "PDF → 이미지",
    note: "고른 쪽을 지정한 dpi로 PNG·JPG·WebP 중 하나로 래스터화하고 여러 장이면 ZIP 하나로 묶는다.",
  ...
  },
  {
    ...
    app: "image",
    label: "변환·압축·리사이즈",
    note: "회전·반전 → 크롭 → 맞춤(여백·잘라내기) → 리샘플 → 인코딩 순서로 한 번에 굽는다. 슬라이더를 움직이면 디바운스 후 다시 굽고 용량 배지가 갱신된다.",
